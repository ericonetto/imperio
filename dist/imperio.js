...
([
	...
	function(module, exports, __webpack_require__) {
		...
		imperio.desktopGPSHandler = __webpack_require__(2);
		...
		// sets up a listener for orientation data and emits object containing latitude, longitude, and out data
		imperio.mobileGPSShare = __webpack_require__(7);
	...
	function(module, exports) {
		...
		// Sets up a listener for the orientation data and expects to receive an object
		// with the gps data in the form of {latitude: latitude, longitude:longitude, out:out}.
		// Accepts 2 arguments:
		// 1. The socket you would like to connect to.
		// 2. A callback function that will be run every time the tap event is triggered.
		var desktopGPSHandler = function desktopGPSHandler(socket, callback) {
			socket.on('gps', function(gpsObj) {
	...
	function(module, exports) {
		...
		// Will send gps data to the socket in the form of {latitude: latitude, longitude:longitude, out:out}.
		// Accepts 3 arguments:
		// 1. The socket you would like to connect to as the first parameter.
		// 2. A room name that will inform the server which room to emit the gps event and data to.
		// 3. A callback function that will be run every time the tap event is triggered, by default
		// we will provide this function with the gps data.
		var mobileGPSShare = function mobileGPSShare(socket, room, callback) {
			socket.on('connect', function() {
				setInterval(function() {
					var latitude = 0;
					var longitude = 0;
					var out = "<p>Locating…</p>";


					if (!navigator.geolocation) {
						out = "<p>Geolocation is not supported by your browser</p>";
						emit();
						return;
					}
					...
					function success(position) {
						...
						out = 'Position aquired';
						emit();
					}

					function error() {
						out = "Unable to retrieve your location";
						emit();
					}
	...
	function(module, exports, __webpack_require__) {
		...
		(function(g, f) {
			'use strict';
			var h = function h(e) {
					if ("object" !== _typeof(e.document)) throw Error(
					...
					b._isValidDate = function(a) {
						return "[object Date]" === Object.prototype.toString.call(a) && !isNaN(
							a.getTime());
					};
					b._getExpiresDate = function(a, d) {
						d = d || new Date();
						"number" === typeof a ? a = Infinity === a ? b._maxExpireDate : new Date(
							d.getTime() + 1E3 * a) : "string" === typeof a && (a = new Date(a));
						if (a && !b._isValidDate(a)) throw Error(
					...
					b._getCacheFromString = function(a) {
						...
						for (var c = 0; c < a.length; c++) {
							...
							d[b._cacheKeyPrefix + e.key] === f && (d[b._cacheKeyPrefix + e.key] =
								e.value);
						}
						return d;
					};
					b._getKeyValuePairFromCookieString = function(a) {
						...
						try {
							...
							console && "function" === typeof console.error && console.error(
								'Could not decode cookie with key "' + c + '"', f);
						}
						return {
							key: e,
							value: a.substr(b + 1)
				...
				e = "object" === _typeof(g.document) ? h(g) : h;
			true ? !(__WEBPACK_AMD_DEFINE_RESULT__ = function() {
						return e;
					}.call(exports, __webpack_require__, exports, module),
					__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports =
						__WEBPACK_AMD_DEFINE_RESULT__)) : "object" === (typeof exports ===
					"undefined" ? "undefined" : _typeof(exports)) ? ("object" === (typeof module ===
					"undefined" ? "undefined" : _typeof(module)) && "object" === _typeof(
					module.exports) && (exports = module.exports = e), exports.Cookies = e) :
				g.Cookies = e;
